...
export const STATUS_TRANSITIONS = [
    ...
    { before: ZODIAC_GAME_STATUSES.NONE, current: ZODIAC_GAME_STATUSES.NONE, next: ZODIAC_GAME_STATUSES.PREPARESTART, delay: 0 },
    { before: ZODIAC_GAME_STATUSES.PREPARESTART, current: ZODIAC_GAME_STATUSES.PREPARESTART, next: ZODIAC_GAME_STATUSES.COUNTDOWN, delay: 0 },
    { before: ZODIAC_GAME_STATUSES.COUNTDOWN, current: ZODIAC_GAME_STATUSES.COUNTDOWN, next: ZODIAC_GAME_STATUSES.RESULTWAITING, delay: 40000 },
    { before: ZODIAC_GAME_STATUSES.RESULTWAITING, current: ZODIAC_GAME_STATUSES.RESULTWAITING, next: ZODIAC_GAME_STATUSES.RESULT, delay: 0 },
    { before: ZODIAC_GAME_STATUSES.RESULT, current: ZODIAC_GAME_STATUSES.RESULT, next: ZODIAC_GAME_STATUSES.END, delay: 4500 },
    { before: ZODIAC_GAME_STATUSES.END, current: ZODIAC_GAME_STATUSES.END, next: ZODIAC_GAME_STATUSES.NONE, delay: 4000 }
];
